...
#import "CLDEMOAppDelegate.h"
#import "CLDEMORootTableViewController.h"
#import <CentrixlinkGlobal/CentrixlinkGlobal.h>
#import "CLDEMOAppInfo.h"

@interface CLDEMOAppDelegate ()
@property (nonatomic, strong) UIViewController *root;

@end

@implementation CLDEMOAppDelegate

- (BOOL)application:(UIApplication *)application
    didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  [CLCentrixlinkGlobalADSDK setDebugEnable:YES];
  [CLCentrixlinkGlobalADSDK startWithAppID:[CLDEMOAppInfo appID]
                              appSecretKey:[CLDEMOAppInfo appKey]
                                     error:nil];
  
  UIViewController *root = [[CLDEMORootTableViewController alloc] init];
